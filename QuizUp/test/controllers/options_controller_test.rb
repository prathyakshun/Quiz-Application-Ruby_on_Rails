...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { Question_id: @option.Question_id, correct: @option.correct, optiontext: @option.optiontext } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { Question_id: @option.Question_id, correct: @option.correct, optiontext: @option.optiontext } }
